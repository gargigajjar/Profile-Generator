...
@Component
public class StructuredDefinitionProvider extends AbstractJaxRsResourceProvider<StructureDefinition> {
	...
	public StructuredDefinitionProvider(FhirContext fhirContext) {
	 ...
	 *
	 */
	public StructuredDefinitionProvider() {
